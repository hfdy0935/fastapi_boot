...
USE_DEP_PREFIX_IN_ENDPOINT = 'fastapi_boot_use_dep_prefix'


# api router's key in controller
API_ROUTER_KEY_IN_CONTROLLER = 'fastapI_boot__api_router_key_in_controller'
