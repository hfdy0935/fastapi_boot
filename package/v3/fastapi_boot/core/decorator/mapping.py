...
from fastapi_boot.model.route import SpecificHttpRouteItemWithoutEndpointAndMethods as SM
from fastapi_boot.model.route import WebSocketRouteItem, WebSocketRouteItemWithoutEndpoint
